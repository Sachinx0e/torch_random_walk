...
def walk_edge_list(edge_list, node_edges_idx,target_nodes, p, q, walk_length, seed):
    return torch_rw_native.walk_edge_list(edge_list,target_nodes,p,q,walk_length,seed) 
